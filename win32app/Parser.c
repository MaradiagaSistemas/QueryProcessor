...
static const char *const yytname[] =
{
  ...
  "TOKEN_ENTRE", "TOKEN_MENOS", "TOKEN_IGUAL", "TOKEN_ASTERISCO",
  "TOKEN_MAS", "TOKEN_SELECT", "TOKEN_INSERT", "TOKEN_UPDATE",
  "TOKEN_DELETE", "TOKEN_AND", "TOKEN_OR", "TOKEN_SUM", "TOKEN_AVG",
  "TOKEN_MIN", "TOKEN_MAX", "TOKEN_COUNT", "TOKEN_ALTER", "TOKEN_ADD",
  "TOKEN_COLUMN", "TOKEN_DROP", "TOKEN_CHANGE", "TOKEN_NULL", "TOKEN_NOT",
  "TOKEN_DEFAULT", "TOKEN_PRIMARY", "TOKEN_FOREIGN", "TOKEN_KEY",
  "TOKEN_HAVING", "TOKEN_GROUP", "TOKEN_BY", "TOKEN_INNER", "TOKEN_JOIN",
  "TOKEN_MAYORQUE", "TOKEN_MENORQUE", "TOKEN_MAYORIGUAL",
  "TOKEN_MENORIGUAL", "TOKEN_AS", "TOKEN_WHERE", "TOKEN_FROM",
  "TOKEN_COMA", "TOKEN_PUNTO", "TOKEN_PUNTOCOMA", "TOKEN_ON",
  "TOKEN_NUMBER", "$accept", "input", "expr", YY_NULL
};
#endif
